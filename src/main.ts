...
function renderSettingsUI() {
  ...
  app.innerHTML = `
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; padding: 20px;">
      <div class="content-container">
        ...
        <div class="url-container"> 
          <input 
            type="text" 
            class="url-input"
            value="https://unduck.schandlserver.de?q=%s"
            readonly 
          />
      ...
      <footer class="footer">
        <p>Made with ❤️ by <a href="https://github.com/Gamerou/unduck" target="_blank">Gamerou</a></p>
        <p>forked from <a href="https://x.com/theo" target="_blank">theo</a> / <a href="https://github.com/t3dotgg/unduck" target="_blank">t3dotgg</a></p>
      </footer>
    </div>
  `;
